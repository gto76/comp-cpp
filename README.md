...
Other versions
--------------
* [**Mark II**](https://github.com/gto76/comp-m2), a model with separate address space for code and data and more instructions. Programs can be saved and loaded and it can run without the interface (instead of a printer it uses stdout) and input can be piped in.  
